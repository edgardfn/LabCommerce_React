...
const OptionFiltro = styled.option`
  ...
  ${(props) => {
    if (props.value === props.valueSelecione) {
...
class App extends React.Component {
  ...
  onChangeSelectFiltro = (event) => {
    this.setState({ selectFiltro: event.target.value, filtro: true, pesquisa: false, inputPesquisa: ""})
  }
  ...
  render(){
    ...
    if(this.state.pesquisa) {
      const retornoPesquisa = this.state.produtos.filter((produto) => {
        let produtoMinusculo = produto.tituloProduto.toLowerCase()
        if( produtoMinusculo.includes(this.state.inputPesquisa) ) {
          return true
        }
        return false
      })
          ...
          <Blocopesquisa >
            ...
            <DivFiltro>
              <SelectFiltro onChange={this.onChangeSelectFiltro} value={this.state.selectFiltro}>
                <OptionFiltro value="selecione" valueSelecione={this.state.selectFiltro}>Selecione um Filtro:</OptionFiltro>
                <OptionFiltro value="todos" valueSelecione={this.state.selectFiltro}>Todos Produtos</OptionFiltro>
                <OptionFiltro value="menor" valueSelecione={this.state.selectFiltro}>Menor preço para Maior preço</OptionFiltro>
                <OptionFiltro value="maior" valueSelecione={this.state.selectFiltro}>Maior preço para Menor preço</OptionFiltro>
                <OptionFiltro value="masculino" valueSelecione={this.state.selectFiltro}>Masculino</OptionFiltro>
                <OptionFiltro value="feminino" valueSelecione={this.state.selectFiltro}>Feminino</OptionFiltro>
              </SelectFiltro>
